...
from tqdm import *
import torchmetrics
from MydataLoader import MyDatasetK,PETCTDataset,MyDatasetRaw
import argparse
...
def run():
    ...
    #继续训练
    state_dict = torch.load('./RN50/'+model_name+'_ckt.pth', map_location="cpu")
    ...
    train_dataset = MyDatasetRaw(is_train=True)
    test_dataset = MyDatasetRaw(is_train=False)
