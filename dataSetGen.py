...
if __name__=="__main__":
    ...
    for i in range(128):
        ...
        pet_gts.append(pet_gt)
        mul_factors.append(pet_noise)
        pet_noises.append(pet_noise)
        # pets.append(pet_gt)
        print(i)

np.savez('./datasetT.npz',pet=pet_gts,sin=sinograms,mulfactor=mul_factors,petnoise=pet_noises)
