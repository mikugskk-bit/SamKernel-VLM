...
import argparse
from model import MLP,Unet,TransformerUnet
...
def run():
    ...
    if model_name == models[0]:
        net = Unet(in_channels=3, n_cls=1, n_filters=16).to(device)
    elif model_name == 'TransUnet' or model_name == 'TransUnetBr':
        net = TransformerUnet(in_channels=3, n_cls=1, n_filters=16).to(device)
