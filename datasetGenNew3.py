...
def process_EM(args):
    ...
    # kemresult1,kemresult2,kemresult3 = MLEMorKEM(sinogram,mul_factor,pet_noise,None,radon=radon,pet_gt=pet_gt1,K=None,method_index='KEM',prefix='KEM',total_iter=30)
    kemresult1,kemresult2,kemresult3 = OSEM(sinogram,mul_factor,pet_noise,pet_gt1,8,4,160)
...
if __name__=="__main__":
    ...
    np.savez('./datasetK3-PETCT-OSEM-192T-Ga-OnlyPET.npz',kem=outputs)
